...
- **Solar system view** -double-click any planet-host star (or tap then press View System Map on mobile) to enter a live 3D system view; full 6-element Keplerian mechanics (a, e, i, Ω, ω, M₀) with Newton-Raphson solver; Sol opens at real current planetary positions (epoch J2000); habitable zone ring (Kopparapu 2013); planet meshes colour-coded by equilibrium temperature; orbit rings with correct 3D orientation; time controls (1d/s to 1yr/s + pause); planet detail panel on click; click the host star for stellar data; data-quality tags distinguish observed vs derived orbital elements; orbital distances scaled for visibility
- **Planet zoom and moon system** - click a planet's name label (or tap "View Moon Orbits" in its info panel) to zoom the camera to that planet and watch its moons orbit in real time; 20 major moons across 6 planets with JPL mean orbital elements (J2000): Earth's Moon, Mars' Phobos and Deimos, Jupiter's Galilean moons, Saturn's six including Titan, Uranus' five major moons, Neptune's Triton; click any moon for its orbital data; moon orbit rings track the planet as it moves; orbit scale anchors the innermost moon just outside the planet sphere so no moon is ever hidden inside; planet and moon sizes use true proportional radii; HZ ring and orbit lines hidden during planet focus
...
- **Planetary rings** -Saturn, Uranus, Neptune and Jupiter render their ring systems with correct 3D orientation (real axial tilt) and proportional radii; Saturn shows 6 bands (D, C, B, Cassini Division, A, F rings); Uranus shows the main narrow ring group (Six through Epsilon) correctly oriented at 97.77° tilt; Neptune shows Galle, Le Verrier/Lassell, and Adams rings; rings follow the planet as it orbits; data from NASA Ring-Moon Systems Node
...
- **Planetary ring radii (inner/outer boundaries per band):** [NASA Ring-Moon Systems Node](https://pds-rings.seti.org) (PDS archive, Caltech/SETI Institute under NASA contract) -public domain. Saturn ring table, Uranus ring table, Neptune ring table, Jupiter ring table. Planet equatorial radii and axial tilts from JPL SSD and IAU WGCCRE (Archinal et al. 2018).
- **Moon orbital elements:** JPL Planetary Satellite Mean Orbital Elements (J2000 epoch) -NASA/JPL public domain
