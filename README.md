...
- **Planet zoom and moon system** - tap "View Moon Orbits" in any planet's info panel to zoom the camera to that planet and watch its moons orbit in real time; 20 major moons across 6 planets with JPL mean orbital elements (J2000): Earth's Moon, Mars' Phobos and Deimos, Jupiter's Galilean moons, Saturn's six including Titan, Uranus' five major moons, Neptune's Triton; click any moon for its orbital data; moon orbit scale computed per-planet for correct visibility; HZ ring and orbit lines hidden during planet focus
